...
1. Key Features
	...
	- Customer Insights
		> Segments customers into three behavioral categories
			>> High-Frequency
			>> Mid-Value
			>> Occasional
...
6. Target Users
	...
	- Business Owners & General Managers
		> Strategic oversight and performance tracking

	- Marketing Teams
		> Campaign development, promotions, and loyalty planning

	- Operations Managers
		> Inventory, staffing, and process improvements

	- Data Analysts
		> Trend analysis and advanced exploration
